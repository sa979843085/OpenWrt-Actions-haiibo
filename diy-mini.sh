...
# 修改默认IP
sed -i 's/192.168.1.1/191.168.100.100/g' package/base-files/files/bin/config_generate
...
git clone --depth=1 lucky https://github.com/gdy666/luci-app-lucky package/luci-app-lucky
